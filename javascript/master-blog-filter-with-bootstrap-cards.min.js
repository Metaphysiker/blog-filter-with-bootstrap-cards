$(document).ready(function(){var bootstrap_cards_object={endpoint:"",category_names:{},per_page:50,categories_to_be_excluded:"0",categories_of_current_page:"0",date_options:{year:"numeric",month:"long",day:"numeric"},current_offset:0,empty_items_container:function(e){$(".bootstrap_cards_items_container").empty()},empty_load_more_button_container:function(e){$(".bootstrap_cards_load_more_button_container").empty()},toggle_spinner:function(e){$(".bootstrap_cards_spinner").toggle()},add_spinner:function(e){bootstrap_cards_object.empty_items_container(),$(".bootstrap_cards_items_container").append(`
    ...
    <div class="col">
      ...
      `)},get_and_append_items:function(a){bootstrap_cards_object.current_offset=bootstrap_cards_object.current_offset+bootstrap_cards_object.per_page;var e={per_page:bootstrap_cards_object.per_page,offset:bootstrap_cards_object.current_offset};"all"==a||(e.categories=a),$.ajax({method:"GET",url:bootstrap_cards_object.endpoint+"wp/v2/posts?_embed",data:e}).done(function(e){if("all"==a)for(var t=0;t<e.length;t++)bootstrap_cards_object.append_item_with_tag(e[t]);else for(t=0;t<e.length;t++)bootstrap_cards_object.append_item(e[t]);bootstrap_cards_object.empty_load_more_button_container(),e.length>=bootstrap_cards_object.per_page&&bootstrap_cards_object.add_load_more_button(a)})},get_and_place_items:function(a){bootstrap_cards_object.toggle_spinner(),bootstrap_cards_object.empty_items_container(),bootstrap_cards_object.empty_load_more_button_container(),bootstrap_cards_object.current_offset=0;var e={per_page:bootstrap_cards_object.per_page};"all"==a||(e.categories=a),$.ajax({method:"GET",url:bootstrap_cards_object.endpoint+"wp/v2/posts?_embed",data:e}).done(function(e){if(bootstrap_cards_object.toggle_spinner(),bootstrap_cards_object.empty_items_container(),"all"==a)for(var t=0;t<e.length;t++)bootstrap_cards_object.append_item_with_tag(e[t]);else for(t=0;t<e.length;t++)bootstrap_cards_object.append_item(e[t]);e.length>=bootstrap_cards_object.per_page?bootstrap_cards_object.add_load_more_button(a):bootstrap_cards_object.empty_load_more_button_container()})},get_and_place_itemsx:function(a){bootstrap_cards_object.toggle_spinner(),bootstrap_cards_object.empty_items_container(),bootstrap_cards_object.empty_load_more_button_container(),bootstrap_cards_object.current_offset=0;var e={per_page:bootstrap_cards_object.per_page};"all"==a||(e.categories=a),$.ajax({method:"GET",url:bootstrap_cards_object.endpoint+"wp/v2/posts?_embed",data:e}).done(function(e){if(bootstrap_cards_object.toggle_spinner(),bootstrap_cards_object.empty_items_container(),"all"==a)for(var t=0;t<e.length;t++)bootstrap_cards_object.append_item_with_tag(e[t]);else for(t=0;t<e.length;t++)bootstrap_cards_object.append_item(e[t]);e.length>=bootstrap_cards_object.per_page?bootstrap_cards_object.add_load_more_button(a):bootstrap_cards_object.empty_load_more_button_container()})},get_and_place_categories:function(e){$.ajax({method:"GET",url:bootstrap_cards_object.endpoint+"wp/v2/categories",data:{exclude:bootstrap_cards_object.categories_to_be_excluded}}).done(function(t){$(".bootstrap_cards_buttons_container").empty();var a=bootstrap_cards_object.categories_of_current_page.split(",");let e="";a.includes("all")&&(e="disabled"),$(".bootstrap_cards_buttons_container").append(`
